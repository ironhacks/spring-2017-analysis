...
```{r}
library('relaimpo')
gpa.model<-lm(total.phase5~tech.phase5 + novelty.phase5 + user.requirement.phase5 + tech.phase5 + infovis.phase5, data=scores_loc)
...
```{r}
library('relaimpo')
gpa.model<-lm(total.phase5~tech.phase5 + novelty.phase5 + user.requirement.phase5 + tech.phase5 + infovis.phase5, data=bogota_3)
calc.relimp(gpa.model, rela=TRUE)
```
...
```{r}
library('relaimpo')
gpa.model<-lm(total.phase5~tech.phase5 + novelty.phase5 + user.requirement.phase5 + tech.phase5 + infovis.phase5, data=bogota_2)
calc.relimp(gpa.model, rela=TRUE)
```
...
```{r}
library('relaimpo')
gpa.model<-lm(total.phase5~tech.phase5 + novelty.phase5 + user.requirement.phase5 + tech.phase5 + infovis.phase5, data=bogota_1)
calc.relimp(gpa.model, rela=TRUE)
```
...
```{r}
library('relaimpo')
gpa.model<-lm(total.phase5~tech.phase5 + novelty.phase5 + user.requirement.phase5 + tech.phase5 + infovis.phase5, data=bogota_0)
calc.relimp(gpa.model, rela=TRUE)
```
