...
```{r}
reduced.model <- lm(log_exploration ~ log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10 , data=df)
summary(reduced.model)
```
```{r}
full.model <- lm(log_exploration ~ group + log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10 , data=df)
summary(full.model)
```
```{r}
