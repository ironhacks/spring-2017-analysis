...
apa.reg.table(lm(log_total ~ log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10, df),filename = "Example9.doc",table.number = 6)
summary(fit)
```
...
apa.reg.table(lm(log_total ~ Group  + log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10, df),filename = "Example8.doc",table.number = 6)
summary(fit.full)
```
...
```{r}
library(apaTables)
apa.reg.table(lm(log_total ~ log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10,df),lm(log_total ~ Group  + log_count + Q7_Q7_1 + Q7_Q7_2 + Q8_Q8_1 + Q10,df),filename = "Example6.doc",table.number = 5)
```
